...
There's another constructor of the [PdfDevice](https://reference.aspose.com/tex/net/aspose.tex.presentation.pdf/pdfdevice/pdfdevice/) class, which lets us get the resulting PDF file in an alternative way.
